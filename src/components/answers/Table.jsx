...
export function Table() {
    return <div className="col-span-12 md:col-span-5 overflow-visible mb-10">
        ...
        <div className="border border-gray-300 h-72 bg-white rounded-2xl shadow-lg  transition-all duration-200 ease-in-out p-2 mt-5 overflow-clip">
            <div className="flex place-content-between bg-gray-200 my-2 mx-4 p-2 overflow-clip">
                <div className="flex">
                    <CalendarIcon />
            ...
            <div className="grid grid-rows-4 divide-y-1 divide-gray-300 mx-4 pb-10">
